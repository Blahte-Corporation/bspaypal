...
use BlahteSoftware\BsPaypal\Exceptions\ConfigurationException;
...
class ReflectionUtil {
    ...
    {
        if ($class == get_class(new BaseModel())) {
            // Make it generic if BaseModel is used for generating this
            return get_class(new BaseModel());
        }
