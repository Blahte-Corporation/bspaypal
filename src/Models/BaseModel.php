...
use ArrayUtil;
use BlahteSoftware\BsPaypal\Utils\ReflectionUtil;
use BlahteSoftware\BsPaypal\Validators\JsonValidator;

/**
 * Base Model class that all API domain classes extend
...
class BaseModel {
     ...
     * This argument eliminates the need
     * to do $obj->fromJson($data) later 
    ...
    /**
     * Returns a list of Object from Array or Json String. 
     * It is generally used when your json
